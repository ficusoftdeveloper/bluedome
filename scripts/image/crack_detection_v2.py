...
# adjust this variable to where the filter files are
filters = "C:/Users/mexic/Documents/MATLAB/FICUS/Phyton_PROTOTYPE/MASSIMO_CODE/extractedMassimo/Massimo_s_code"
# adjust these variables to the location and name of output files
...
rows_dataset=2448
cols_dataset=3264
img_blur = cv2.bilateralFilter(cv2.resize(imgorig,(cols_dataset,rows_dataset)) ,51,201,201)
